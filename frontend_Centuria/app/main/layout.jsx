                        ...
                        <aside
                            ...
                            <div className="mb-6 flex justify-end lg:hidden">
                                <button type="button" data-sidebar-close ref={closeButton}
                                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/20 bg-[#0d1117] text-white"
                            ...
                            <ul className="flex flex-col gap-4 sticky top-10">
                                ...
                                <Link className={`rounded-lg px-2 py-2 transition hover:bg-[#212830] flex gap-2 ${pathname.includes('/explore') ? 'bg-[#212830] border-l-4 rounded-l-none border-blue-500' : ''}`} href={'/main/explore'}><img className='w-[20px] fill-white/50 hover:fill-white' src="/svg/explore.svg" alt="" /> explore</Link>
                                ...
                                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div className="flex items-center gap-3 ">
                                        ...
                                        <button type="button" ref={toggle} aria-expanded="false"
                                            className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/20 bg-[#0d1117] text-white lg:hidden">
