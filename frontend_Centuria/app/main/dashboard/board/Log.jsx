...
export default function Log({ habit, index_date, current_log_index }) {
    ...
    return (
        <>
            {new Date(habit.last_log?.completed_date).setHours(0,0,0,0) != index_date ?

                <td className="border-x border-solid border-[#86878b] min-w-[25px] text-center cursor-pointer">
                ...
                :
                <td className="border-x border-solid border-[#86878b] min-w-[25px] text-center bg-green-800 cursor-pointer">
