...
export default function EditPost() {
    ...
    function handleChange(e) {
        ...
        if (name == 'UploadedImages[]') {
            const { files } = e.target;
            setData(prev => ({ ...prev, UploadedImages: Array.from(files) }));
                ...
                <div className="grid gap-5 md:grid-cols-2">
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="images" className="flex flex-col gap-2">
                            ...
                            <input type="file" name="UploadedImages[]" id="images" accept="image/*" multiple onChange={handleChange}
